...
<table width="863" border="0">
  <tr bgcolor="#E5E5E5">
    <td height="70" colspan="2"><div align="center">SADCO DIAL-OUT ADMIN </div></td>
  </tr>
  <tr>
    <td width="175" height="200"><div id="ddsidemenubar" class="markermenu">
      <ul>
        ...
        <li><a href="" rel="ddsubmenuside2">Import Numbers</a></li>
        <li><a href="index.php?id=3">report</a></li>
        <li><a href="index.php?id=4" >Setting</a></li>
...
ddlevelsmenu.setup("ddsidemenubar", "sidebar") //ddlevelsmenu.setup("mainmenuid", "topbar|sidebar")
    ...
    <td width="630" rowspan="2"><div align="left">
	<style type="text/css">
...
$opts['fdd']['prefix'] = array(
  'name'     => 'Prefix',
  'select'   => 'T',
  'maxlen'   => 10,
  'sort'     => true
);
$opts['fdd']['max_call'] = array(
  'name'     => 'Max call',
  'select'   => 'T',
  'maxlen'   => 11,
  'sort'     => true
...
?>
  ...
  <tr bgcolor="#E5E5E5">
    <td height="50" colspan="2"><div align="center">copyright 2012 parsipal.com </div></td>
  </tr>
</table>
<h3>&nbsp;</h3>
